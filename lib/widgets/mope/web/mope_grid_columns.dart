...
import 'package:site_documentacao_api/widgets/mope/web/blank_grid_title.dart';
...
class MopeGridColumns extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ConstrainedBox(
      constraints: const BoxConstraints(maxHeight: 1545.0),
      child: Row(
        children: [
          const SizedBox(width: 250.0),
          const BlankGridTitle(flex: 1),
          Container(color: setColor(brightness), width: 1.0),
          const BlankGridTitle(flex: 1),
          Container(color: setColor(brightness), width: 1.0),
          const BlankGridTitle(flex: 1),
          Container(color: Colors.orange, width: 2.0),
          const BlankGridTitle(flex: 1),
          Container(color: setColor(brightness), width: 1.0),
          const BlankGridTitle(flex: 1),
          Container(color: setColor(brightness), width: 1.0),
