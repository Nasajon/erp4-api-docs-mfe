...
class GerneralDisposalsPage extends StatefulWidget {
  const GerneralDisposalsPage({super.key});

  @override
  State<GerneralDisposalsPage> createState() => _GerneralDisposalsPageState();
}

class _GerneralDisposalsPageState extends State<GerneralDisposalsPage> {
